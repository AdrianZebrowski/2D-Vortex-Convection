...
fig2.suptitle('Figure 9: Comparison of $u$ profiles at $x=x_c$, x-convection case',fontsize=10, weight='bold')
...
fig3.suptitle('Figure 10: Comparison of $\omega$ profiles at $x=x_c$, x-convection case',fontsize=10, weight='bold')
...
fig4.suptitle('Figure 11: Comparison of error convergence rates, x-convection case',fontsize=10, weight='bold')
