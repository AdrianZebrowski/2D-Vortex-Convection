...
fig1.suptitle('Figure 4: Comparison of $\omega$ contours, baseline case, N = 100',fontsize=10, weight='bold')
...
fig2.suptitle('Figure 5: Comparison of $u$ profiles at $x=x_c$, baseline case',fontsize=10, weight='bold')
...
fig4.suptitle('Figure 7: Comparison of error convergence rates, baseline case',fontsize=10, weight='bold')
