...
fig2.suptitle('Figure 13: Comparison of $u$ profiles at $x=x_c$, y-convection case',fontsize=10, weight='bold')
...
fig3.suptitle('Figure 14: Comparison of $\omega$ profiles at $x=x_c$, y-convection case',fontsize=10, weight='bold')
...
fig4.suptitle('Figure 15: Comparison of error convergence rates, y-convection case',fontsize=10, weight='bold')
